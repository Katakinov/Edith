...
class AppController {
    ...
    private val nodesArray: Array<NodeDef> = arrayOf(
        NodeDef( "Float значение", "float-input.fxml", NodeDef.NodeType.INPUT ),
        NodeDef( "Integer значение", "int-input.fxml", NodeDef.NodeType.INPUT ),
        NodeDef( "String значение", "string-input.fxml", NodeDef.NodeType.INPUT ),
        NodeDef( "Image значение", "image-input.fxml", NodeDef.NodeType.INPUT ),

        NodeDef( "Добавить текст", "add-text-node.fxml", NodeDef.NodeType.FUNCTION ),
        NodeDef( "Вставить картинку", "add-image-node.fxml", NodeDef.NodeType.FUNCTION ),
        NodeDef( "Серый фильтр", "gray-filter-node.fxml", NodeDef.NodeType.FUNCTION ),
        NodeDef( "Сепия фильтр", "sepia-filter-node.fxml", NodeDef.NodeType.FUNCTION ),
        NodeDef( "Яркость", "brightness-node.fxml", NodeDef.NodeType.FUNCTION ),
        NodeDef( "Инверсия", "invert-filter-node.fxml", NodeDef.NodeType.FUNCTION ),
        NodeDef( "Размытие Гаусса", "gaussian-blur-node.fxml", NodeDef.NodeType.FUNCTION ),
        NodeDef( "Сдвиг", "transform-move-node.fxml", NodeDef.NodeType.FUNCTION ),
        NodeDef( "Изменить размер", "transform-scale-node.fxml", NodeDef.NodeType.FUNCTION ),
        NodeDef( "Повернуть", "transform-rotate-node.fxml", NodeDef.NodeType.FUNCTION ),
    )
    ...
    private fun saveScene() {
        val choosenFile = FileUtils
            .getFileChooser("Сохранить сцену как", "Scene Files", "*.scene")
    ...
    private fun loadScene() {
        val choosenFile = FileUtils
            .getFileChooser("Загрузить сцену", "Scene Files", "*.scene")
